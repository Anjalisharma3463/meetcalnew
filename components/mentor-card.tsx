...
const MentorCard: React.FC<{ mentor: Mentor }> = ({ mentor }) => {
  ...
  return (
    <div className="bg-white border h-[168px] rounded-lg p-4 flex items-start space-x-4 mx-[106px] ">
      {/* Profile Image */}
      <div className="w-35 h-35 flex-shrink-0 relative">
        <Image 
          src={profile} 
          alt={mentor.name} 
...
>
  View profile
        ...
        <p className="text-xs bg-[#CBD5E1] h-20 rounded-md p-2 text-gray-500 mb-2">
